...
class MainActivity : AppCompatActivity() {
   ...
   /** private fun displayNote() {
        ...
        val coursePosition = DataManager.courses.values.indexOf(element = note.course)
   ...
   private fun displayNote(){
       if (notePosition > DataManager.notes.lastIndex){
           ...
           Log.e("","Invalid note position $notePosition, max valid position ${DataManager.notes.lastIndex}")
           return
       }
       Log.i("","Displaying note for position $notePosition")
       val note = DataManager.notes[notePosition]
       textNoteTitle.setText(note.title)
       textNoteText.setText(note.text)
